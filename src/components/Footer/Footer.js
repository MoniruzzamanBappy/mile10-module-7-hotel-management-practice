  ...
  return (
    ...
    <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
      ...
      <div className="flex justify-center">
        <Link target="_blank" to="/" className="mr-6 text-gray-600">
    ...
    <div className="mx-6 py-10 text-center md:text-left">
      <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <div className="">
          ...
          <p>
            Here you can admit your child and make an oppurtunity to grow their mind for the bright future. Which helps them to build their own creative enbironment.
          </p>
        </div>
        <div className="">
          ...
          <p className="mb-4">
            <Link to="#!" className="text-gray-600">HTML</Link>
          </p>
          <p className="mb-4">
            <Link to="#!" className="text-gray-600">CSS</Link>
          </p>
          <p className="mb-4">
            <Link  to="#!" className="text-gray-600">JS</Link>
          </p>
    ...
    <div className="text-center p-6 bg-gray-200">
      ...
      <Link className="text-gray-600 font-semibold" to="https://tailwind-elements.com/"> Md. Bappy</Link>
    </div>
  </footer>
  );
};
